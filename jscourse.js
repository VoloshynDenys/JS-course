...
let num = 666;
console.log(num.toString(2));	// 1010011010 -	число 666 в двоичной системе счисления
console.log(num.toString(8));	// 1232 -	число 666 в восьмеричной системе счисления
console.log(num.toString(16));	// 29a -	число 666 в шестнадцетиричной системе счисления

console.log(666..toString(36));	//	ii
// Внимание! Две точки в 123456..toString(36) это не опечатка. Если нам надо
// вызвать метод непосредственно на числе, как toString в примере выше, то нам надо
// поставить две точки .. после числа.
